...
| [Physical models](../openspec/specs/physical-models/spec.md) | Navier-Stokes, Shan-Chen multiphase, porous media, thermal | 🟡 Navier-Stokes cavity + AD scalar transport (one-way fluid-coupled); multiphase/thermal/porous planned |
